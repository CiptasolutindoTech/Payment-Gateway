...
namespace Cst\PaymentGateway\Base\Gateways;

use Cst\PaymentGateway\Base\GlobalCurrency;
use Cst\PaymentGateway\Base\PaymentGatewayBase;
use Unicodeveloper\Paystack\Facades\Paystack;
use Cst\PaymentGateway\Traits\CurrencySupport;
use Cst\PaymentGateway\Traits\PaymentEnvironment;
...
class PaystackPay extends PaymentGatewayBase
{
    ...
    {
        if (in_array($this->charge_currency(), $this->supported_currency_list())){
            return $amount;
        }
